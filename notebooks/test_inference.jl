...
function loglikelihood(x₁, x₂, t₁, t₂, σ_x₁, σ_x₂, params)
	...
	return log_likelihood(𝓒₁₂, t₁, t₂, x₁, x₂, σ_x₁ .^ 2, σ_x₂ .^ 2, f0, fM, n_components)
end
logl(pars) = loglikelihood(x₁, x₂, t, t, σ_x₁, σ_x₂, pars)
...
function prior_transform(cube)
	...
	α₁² = quantile(Uniform(0.0, 1.25), cube[4])
	f₁² = quantile(LogUniform(min_f_b, max_f_b), cube[5])
	α₂² = quantile(Uniform(α₁², 4.0), cube[6])
	Δτ = quantile(Uniform(-t[end], t[end]), cube[7])
